...
VTKRender::Image* VTKRender::Series::getNextSingleFrameImage(Image* t_image)
{
...
//-----------------------------------------------------------------------------
VTKRender::Image* VTKRender::Series::getPreviousSingleFrameImage(Image* t_image)
{
...
//-----------------------------------------------------------------------------
VTKRender::Image* VTKRender::Series::getSingleFrameImageByIndex(const int& t_index)
{
	auto it = m_singleFrameImages.begin();
...
//-----------------------------------------------------------------------------
vtkSmartPointer<vtkDICOMReader> VTKRender::Series::getReaderForAllSingleFrameImages()
{
...
//-----------------------------------------------------------------------------
vtkSmartPointer<vtkDICOMMetaData> VTKRender::Series::getMetaDataForSeries()
{
...
//-----------------------------------------------------------------------------
VTKRender::Image* VTKRender::Series::addSingleFrameImage(std::unique_ptr<Image> t_image, bool& t_newImage)
{
...
//-----------------------------------------------------------------------------
VTKRender::Image* VTKRender::Series::addMultiFrameImage(std::unique_ptr<Image> t_image, bool& t_newImage)
{
...
//-----------------------------------------------------------------------------
bool VTKRender::Series::isLess(Series* t_lhs, Series* t_rhs)
{
	return t_lhs->getUID() < t_rhs->getUID();
}

//-----------------------------------------------------------------------------
std::size_t VTKRender::Series::findImageIndex(
