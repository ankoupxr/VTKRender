...
VTKRender::VTKBiDimensionalCallback* VTKRender::VTKBiDimensionalCallback::New()
{
	return new VTKBiDimensionalCallback;
}

void VTKRender::VTKBiDimensionalCallback::Execute(vtkObject* caller, unsigned long, void*)
{
...
VTKRender::VTKBiDimensionalCallback::VTKBiDimensionalCallback()
{
}
