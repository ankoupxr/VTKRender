...
QT_MOC_LITERAL(4, 22, 8), // "OnPushOk"
QT_MOC_LITERAL(5, 31, 12) // "OnPushCancel"

    },
    "DicomDir\0sendData\0\0Id\0OnPushOk\0"
    "OnPushCancel"
};
...
void DicomDir::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<DicomDir *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (DicomDir::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DicomDir::sendData)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject DicomDir::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_DicomDir.data,
    qt_meta_data_DicomDir,
    qt_static_metacall,
    nullptr,
    nullptr
} };
